...
@app.on_callback_query(filters.regex("ShreemousAdmin") & ~BANNED_USERS)
async def Shreemous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("ShreePlaylists") & ~BANNED_USERS)
@languageCB
