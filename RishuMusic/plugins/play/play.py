...
@app.on_callback_query(filters.regex("AnshmousAdmin") & ~BANNED_USERS)
async def Anshmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("AnshPlaylists") & ~BANNED_USERS)
@languageCB
